...
用法：
    python version_manager.py --action list --slug example_xiaoming --base-dir ~/.openclaw/...
    python version_manager.py --action rollback --slug example_xiaoming --version v2 --base-dir ~/.openclaw/...
"""
...
def main():
    ...
    parser.add_argument("--slug", required=True, help="群友 slug")
