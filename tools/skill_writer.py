...
用法：
    python3 skill_writer.py --action create --slug example_xiaoming --meta meta.json \
        --persona persona_content.md \
        --base-dir ./pigs

    python3 skill_writer.py --action update --slug example_xiaoming \
...
def create_skill(
    ...
    persona_only = (
        f"---\nname: pig_{slug}_persona\n"
        f"description: {name} 的人物性格\n"
